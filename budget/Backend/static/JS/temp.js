    ...
    return {
        ...
        changeType: function() {
            var fields = document.querySelectorAll(
                DOMstrings.inputType + ',' + DOMstrings.inputCategory +',' + DOMstrings.inputDescription + ',' + DOMstrings.inputAmount);
...
var ChartController = (function() {
    return {
        updateTotalChart: function() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    Plotly.newPlot('overall_piegraph', data);
                }
            });
        },

        updateIncomeChart: function() {
            var incomeRecords;
            incomeRecords = JSON.stringify(BudgetController.getIncomeRecords());
            $.ajax({
                url: "/income_plot",
                type: "POST",
                contentType: 'application/json;charset=UTF-8',
                ...
                dataType:"json",
                success: function(data) {
                    Plotly.newPlot('income_piegraph', data);
                }
            });
        },
        ...
        updateExpenseChart: function() {
            var expenseRecords;
            expenseRecords = JSON.stringify(BudgetController.getExpenseRecords());
            $.ajax({
                url: "/expense_plot",
                type: "POST",
                contentType: 'application/json;charset=UTF-8',
                ...
                dataType:"json",
                success: function(data) {
                    Plotly.newPlot('expense_piegraph', data);
                }
            });
        }
    }
...
var addItem = function() {
    ...
    // ChartController.updateTotalChart();
    ChartController.updateIncomeChart();
    ChartController.updateExpenseChart();
}
